...
![image1]({{site.url}}{{site.baseurl}}/assets/images/git간단1.png)
...
![image2]({{site.url}}{{site.baseurl}}/assets/images/git간단2.png)
...
![image3]({{site.url}}{{site.baseurl}}/assets/images/git간단3.png)
...
![image4]({{site.url}}{{site.baseurl}}/assets/images/git간단4.png)
...
![image5]({{site.url}}{{site.baseurl}}/assets/images/git간단5.png)

-> git status를 통해서는 파일 수정, 삭제, 추가에 따라 변경사항을 볼 수 있음



![image6]({{site.url}}{{site.baseurl}}/assets/images/git간단6.png)
